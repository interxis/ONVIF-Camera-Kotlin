...
public class CustomDigestAuthProvider(
    ...
    private val logger = KtorSimpleLogger("DigestAuth")
    ...
    override suspend fun addRequestHeaders(request: HttpRequestBuilder, authHeader: HttpAuthHeader?) {
        ...
        val ncString = nonceCount.toString().padStart(8, '0')
        ...
        val tokenSequence = if (actualQop == null) {
            ...
            listOf(start, nonce, ncString, clientNonce, actualQop, end)
        }
        logger.info("method: $methodName username: ${credentials.username} realm: $realm password: ${credentials.password} qop: $actualQop url ${url.fullPath}")
        logger.info(tokenSequence.toString())
